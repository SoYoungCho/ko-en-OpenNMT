...
if __name__ == '__main__':
    ...
    name = ["data/src-train-MeSen.txt", "data/src-valid-MeSen.txt", "data/src-test-MeSen.txt",
            "data/tgt-train-MeSen.txt", "data/tgt-valid-MeSen.txt", "data/tgt-test-MeSen.txt",]
    #korean_token(a[0])
    #english_token(a[1])
    main(kor,eng,name)